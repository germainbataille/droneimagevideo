...
Route::get('/albums-videos', 'AlbumsVideosController@index')->name('albums-videos');
Route::get('/albums-videos/create', 'AlbumsVideosController@create')->name('albums-videos-create');
Route::post('/albums-videos/store', 'AlbumsVideosController@store')->name('albums-videos-store');
Route::get('/albums-videos/{id}','AlbumsVideosController@show')->name('albums-videos-show');
